...
@section('title', request('tag'))

@section('content') {{-- Remplit la section content de base.blade.php--}}

<p class="uk-text-lead uk-text-center">Il y'a  {{ $articles->total()}} article(s) dans la catégorie {{ request('tag') }}.</p>
...
<div class="uk-alert uk-alert-primary no-more" hidden>
    ...
    <p class="uk-text-center">Fin des articles dans la catégorie {{ request('tag') }}.</p>
