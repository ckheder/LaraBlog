...
@section('title', 'Lara Blog') {{-- titre de page --}}

@section('content') {{-- Remplit la section content de base.blade.php--}}

{{-- affichage des catégories et du nombre d'articles associés --}}

<div class="uk-float-right">

    <p class="uk-text-lead"><span class="uk-margin-small-right" uk-icon="folder"></span>Catégories</p>
    ...
    <ul class="uk-list">
        ...
        @foreach ($tags as $tag)
            ...
            <li>
                ...
                <a href="{{ route('showbytag', ['tag' => $tag->nametags]) }}">{{ $tag->nametags }} ({{ $tag->article_count }})</a>
...
<p class="uk-text-lead"><span class="uk-margin-small-right" uk-icon="file-text"></span>Derniers articles</p>
            ...
            <p>{!! $article->corps_article !!}</p>
                ...
                <div class="uk-grid-small uk-child-width-auto" uk-grid>
                    ...
                    <div>
                        ...
                        <a href="articles/read/{{ $article->id_article }}">Lire</a>
